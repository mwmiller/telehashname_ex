defmodule TelehashnameTest do
  ...
  assert Telehashname.from_tuples(csk_list) == {"jvdoio6kjvf3yqnxfvck43twaibbg4pmb7y3mqnvxafb26rqllwa",
  ...
  assert Telehashname.from_tuples(csk_list) == {"27ywx5e5ylzxfzxrhptowvwntqrd3jhksyxrfkzi6jfn64d3lwxa",
  ...
  assert Telehashname.from_tuples(csk_list) == {"echmb6eke2f6z2mqdwifrt6i6hkkfua7hiisgrms6pwttd6jubiq",
                                                %{"1a" => "ym7p66flpzyncnwkzxv2qk5dtosgnnstgfhw6xj2wvbvm7oz5oaq"}
                                               }
  end
